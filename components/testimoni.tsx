    ...
    const testimonials: Testimonial[] = [
        {
            ...
            rating: 5,
            text: "Sapphire Residence Sumbang lokasinya terbilang lumayan dekat dari Purwokerto. Mengarah ke Purbalingga, jalannya cukup oke. Desainnya menarik pas untuk pasangan muda yang baru menikah dan juga yang mempunya anak satu. Daerahnya masih terbilang adem deh. Pokoknya enjoy aja.",
        },
        {
            id: 2,
            name: "Pradita Oksinata",
            location: "",
            image: "https://res.cloudinary.com/dx8w9qwl6/image/upload/v1764488270/gambar-7_xwoonm.avif",
            rating: 5,
            text: "Rumahnya asri adem kaya lagi di villa sejuk hawanya bikin betah di rumah.",
        },
