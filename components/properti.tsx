...
const pesan = "Halo, saya tertarik dengan properti Sapphire Residence Sumbang";
...
export default function Properties() {
  ...
  const properties = [
    {
      id: 1,
      images: [
        "https://res.cloudinary.com/dqobwse9q/image/upload/v1754879441/01_3_-_Photo_n758sx.png",
        "https://res.cloudinary.com/dqobwse9q/image/upload/v1754879437/01_4_-_Photo_mzvqvw.png",
      ],
      floorPlan: "https://res.cloudinary.com/dqobwse9q/image/upload/v1762287158/Tipe_36_x5tczp.avif",
      name: "Tipe 36",
      price: "7XX.XX.XXX",
      bedrooms: 2,
      bathrooms: 1,
      area: "84",
      description:
        "Tipe 36/84 dengan 1 lantai adalah pilihan ideal untuk pasangan muda yang menginginkan rumah mewah di kawasan eksklusif. Dengan desain yang efisien, rumah ini menawarkan kenyamanan dengan harga terjangkau.",
      certificate: "SHM",
    },
        {
      id: 2,
      ...
      floorPlan: "https://res.cloudinary.com/dqobwse9q/image/upload/v1762287156/Tipe_4598_srslc5.avif",
      name: "Tipe 45",
      price: "7XX.XX.XXX",
      bedrooms: 2,
      bathrooms: 1,
      area: "98",
      description:
        "Tipe 45/98 dengan 1 lantai adalah pilihan ideal untuk pasangan muda yang menginginkan rumah mewah di kawasan eksklusif. Dengan desain yang efisien, rumah ini menawarkan kenyamanan dengan harga terjangkau.",
      certificate: "SHM",
    },
        {
      id: 3,
      ...
      floorPlan: "https://res.cloudinary.com/dqobwse9q/image/upload/v1762287160/Tipe_45_ldmdst.avif",
      name: "Tipe 45",
      price: "7XX.XX.XXX",
      bedrooms: 3,
      bathrooms: 1,
      area: "78",
      description:
        "Tipe 45/78 dengan 1 lantai adalah pilihan ideal untuk pasangan muda yang menginginkan rumah mewah di kawasan eksklusif. Dengan desain yang efisien, rumah ini menawarkan kenyamanan dengan harga terjangkau.",
      certificate: "SHM",
    },
        {
      id: 4,
      ...
      floorPlan: "https://res.cloudinary.com/dqobwse9q/image/upload/v1762287161/Tipe_43_usljy6.avif",
      name: "Tipe 43",
      price: "7XX.XX.XXX",
      bedrooms: 2,
      bathrooms: 1,
      area: "84",
      description:
        "Tipe 43/84 dengan 1 lantai adalah pilihan ideal untuk pasangan muda yang menginginkan rumah mewah di kawasan eksklusif. Dengan desain yang efisien, rumah ini menawarkan kenyamanan dengan harga terjangkau.",
      certificate: "SHM",
    },
        {
      id: 5,
      ...
      floorPlan: "https://res.cloudinary.com/dqobwse9q/image/upload/v1762287162/Tipe_50_prfssd.avif",
      name: "Tipe 50",
      price: "7XX.XX.XXX",
      bedrooms: 2,
      bathrooms: 1,
      area: "84",
      description:
        "Tipe 50/84 dengan 1 lantai adalah pilihan ideal untuk pasangan muda yang menginginkan rumah mewah di kawasan eksklusif. Dengan desain yang efisien, rumah ini menawarkan kenyamanan dengan harga terjangkau.",
      certificate: "SHM",
    },
        {
      id: 6,
      ...
      floorPlan: "https://res.cloudinary.com/dqobwse9q/image/upload/v1762287154/Tipe_51_gmfrzn.avif",
      name: "Tipe 51",
      price: "7XX.XX.XXX",
      bedrooms: 3,
      bathrooms: 1,
      area: "112",
      description:
        "Tipe 51/112 dengan 1 lantai adalah pilihan ideal untuk pasangan muda yang menginginkan rumah mewah di kawasan eksklusif. Dengan desain yang efisien, rumah ini menawarkan kenyamanan dengan harga terjangkau.",
      certificate: "SHM",
    },
    {
      id: 7,
      ...
      floorPlan: "https://res.cloudinary.com/dqobwse9q/image/upload/v1762287154/Tipe_25_ksvjaq.avif",
      name: "Tipe 25",
      price: "7XX.XX.XXX",
      bedrooms: 1,
      bathrooms: 1,
      area: "42",
      description:
        "Tipe 25/42 dengan 1 lantai adalah pilihan ideal untuk pasangan muda yang menginginkan rumah mewah di kawasan eksklusif. Dengan desain yang efisien, rumah ini menawarkan kenyamanan dengan harga terjangkau.",
      certificate: "SHM",
    },
    {
      id: 8,
      ...
      floorPlan: "https://res.cloudinary.com/dqobwse9q/image/upload/v1762287153/Tipe_52_hc3gin.avif",
      name: "Tipe 52",
      price: "7XX.XX.XXX",
      bedrooms: 3,
      bathrooms: 1,
      area: "91",
      description:
        "Tipe 52/91 dengan 1 lantai adalah pilihan ideal untuk pasangan muda yang menginginkan rumah mewah di kawasan eksklusif. Dengan desain yang efisien, rumah ini menawarkan kenyamanan dengan harga terjangkau.",
      certificate: "SHM",
    },
  ]
  ...
  const siteplan = {
    id: "siteplan-1",
    image: "https://res.cloudinary.com/dqobwse9q/image/upload/v1762287157/Siteplan_oyaap2.avif",
    name: "Siteplan Sapphire Residence Sumbang",
    description:
      "Masterplan perumahan Sapphire Residence Sumbang yang menampilkan layout, jalan, ruang terbuka hijau, dan fasilitas umum.",
  }
  ...
  const specifications = {
    ...
    elektrikal: "Model Downlight Warmwhite",
    // mezanin: "double hollow, lantai SPC (type 55)",
    // fiturRumah: "kanopi rangka hollow, cover wood plank, smart door lock",
  }

  const location = {
    embed: '<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2838.879560618977!2d109.27263477318685!3d-7.3635593724558035!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e655fb0f89cb4e7%3A0x479763efef9c086c!2sSapphire%20Residence%20Sumbang!5e1!3m2!1sid!2sid!4v1761746247513!5m2!1sid!2sid" width="120%" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>',
    name: "Denah Lokasi Sapphire Residence Sumbang",
          ...
          <div className="specifications-container">
            ...
            <div className="specifications-content">
              ...
              <div className="specifications-list">
                ...
                <div className="specification-item">
                  <span className="specification-label">Kusen:</span>
                  <span className="specification-value">{specifications.kusenPintu}</span>
                </div>
                <div className="specification-item">
          ...
          <div className="location-container">
            ...
            <div className="location-content">
              ...
              <div className="location-button-container">
                <Link
                  href="https://maps.app.goo.gl/8PXFt2X5T7RwHqu58"
                  target="_blank"
