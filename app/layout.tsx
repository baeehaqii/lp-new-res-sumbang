...
export const metadata: Metadata = {
  title: "Sapphire Residence Sumbang",
  description: "Temukan properti impian Anda bersama Sapphire Residence Sumbang",
  icons: {
...
'https://www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);
})(window,document,'script','dataLayer','GTM-M5RJ9DT3');`
        }} />
      ...
      <body style={{ fontFamily: '-apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, "Helvetica Neue", Arial, sans-serif' }}>
        ...
        <noscript>
          <iframe src="https://www.googletagmanager.com/ns.html?id=GTM-M5RJ9DT3"
